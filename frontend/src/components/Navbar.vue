      ...
      <div class="right-section">
        ...
        <div class="auth-links">
          <el-dropdown v-if="user" trigger="hover" placement="bottom" size="default">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item @click="router.push('/profile')"><el-icon><UserFilled /></el-icon>My Profile</el-dropdown-item>
                <el-dropdown-item @click="router.push('/orders')"><el-icon><Box /></el-icon>My Orders</el-dropdown-item>
